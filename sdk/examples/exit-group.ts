...
import { exitGroup, ExitGroupConfig, accountPolicyId, groupPolicyId, assetNameLabels } from "@dcu/sdk";
...
async function main() {
    ...
    if (!hasAccountToken) throw new Error(
    ...
    console.log(`Account (222) token(s) found in ${activeWallet} wallet — endpoint will auto-detect the correct one.`);
