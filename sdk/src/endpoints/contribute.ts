...
export const unsignedContributeTxProgram = (
  ...
  Effect.gen(function* () {
    ...
    if (!('TreasuryState' in treasuryDatum)) {
        return yield* Effect.fail(new InvalidDatumError({ field: "treasuryDatum", reason: "Expected TreasuryState for Contribute" }));
    }
    ...
    const tx = yield* lucid
        ...
        .completeProgram()
        .pipe(Effect.mapError(e => new TransactionBuildError({ operation: "contribute", error: String(e) })));
